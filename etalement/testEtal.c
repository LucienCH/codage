...
int main() {
	...
	etaler(messages, nb_messages, taille_message, matrice, taille_matrice, etalement);
	
	printf("Étalement du message : ");
	printf("\n");
